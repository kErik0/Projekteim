...
<div class="newteam">
    <form action="edit_team_register.php" method="post">

           <div class="form-group">
                <input type="text" class="form-control" name="teamid"  placeholder="Csapat száma">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" name="teamname" placeholder="Csapat új neve">
            </div>
            <div class="form-group">
            ...
            <div class="form-btn">
                <input type="submit" class="btn btn-warning" value="Módosítás" name="submit">
            </div>
        </form>
</div>    
