...
<div class="newteam">
    <form action="edit_member_register.php" method="post">
    ...
    <div class="form-group">
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="personnumber" placeholder="Személyi szám">
            </div>
            <div class="form-group">
                <input type="date" class="form-control" name="birthday" placeholder="Születésnapja">
            </div>
            <div class="form-btn">
                <input type="submit" class="btn btn-warning" value="Módosít" name="submit">
            </div>
        </form>
</div>    
